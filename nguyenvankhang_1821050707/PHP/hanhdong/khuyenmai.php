                ...
                <div class="banner_nav"> 
                    <ul class="banner_nav_navbar">
                        <li class="banner_nav_navbar_item">
                            <a href="index2.php?page_layout=list" class="nav_navbar_link">Tin tức chung</a>
                        </li>
                        <li class="banner_nav_navbar_item" style="background-color: #c8102e">
                            <a href="index2.php?page_layout=list2" style="color: white" class="nav_navbar_link">Tin Khuyến Mãi</a>
                        </li>
                        <li class="banner_nav_navbar_item">
                    ...
                    <?php
                        while($row = mysqli_fetch_assoc($query)){ ?>
                            <tr>
                                ...
                                <td>
                                <a class = "btn btn-danger "href="index2.php?page_layout=delete2&id=<?php echo $row['ID']; ?>">Delete</a>
                            
                                </td>
                                <td>
                                <a class = "btn btn-warning"href="index2.php?page_layout=sua2&id=<?php echo $row['ID']; ?>">sửa</td>
                            </tr>
                    <?php    }  ?>
                </tbody>
            </table>
            <a href="index2.php?page_layout=them2" class="btn btn-primary">Thêm mới</a>
        </div>
    </div>
</body>
</html>