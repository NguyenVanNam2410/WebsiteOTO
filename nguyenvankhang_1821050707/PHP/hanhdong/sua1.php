 ...
 <?php
    include "../connect.php";
        $sql = "SELECT * FROM `tbl_sukien` WHERE ID = '$_GET[id]' ";
    ...
    if(isset($_POST['sbm']))
    {
        ...
        move_uploaded_file($tmp_name,$path.$anh);
            $sql = "UPDATE `tbl_sukien` set image = '$anh' where ID ='$_GET[id]'";
            mysqli_query($conn,$sql);
            header('location: sukien.php');
        }

        $sql = "UPDATE `tbl_sukien` set  tin = '$tin' , ngay = '$date' where ID = '$_GET[id]' ";
        mysqli_query($conn,$sql);
