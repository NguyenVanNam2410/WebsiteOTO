                ...
                <div class="banner_nav"> 
                    <ul class="banner_nav_navbar">
                        ...
                        <li class="banner_nav_navbar_item" style="background-color: #c8102e">
                            <a href="index2.php?page_layout=list1" style="color: white" class="nav_navbar_link">Tin sự kiện</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <?php
                        while($row = mysqli_fetch_assoc($query)){ ?>
                            <tr>
                                ...
                                <td>
                                <a class = "btn btn-danger "href="index2.php?page_layout=delete1&id=<?php echo $row['ID']; ?>">Delete</a>
                            
                                </td>
                                <td>
                                <a class = "btn btn-warning"href="index2.php?page_layout=sua1&id=<?php echo $row['ID']; ?>">sửa</td>
                            </tr>
                    <?php    }  ?>
                </tbody>
            </table>
            <a href="index2.php?page_layout=them1" class="btn btn-primary">Thêm mới</a>
        </div>
    </div>
</body>
</html>